        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="mb-5"
            >
              <Badge pulseDot={true}>STATUS: READY // OPEN_TO_WORK</Badge>
            </motion.div>
            ...
            >
              <span
                className={
                  isCobalt ? "text-white font-bold" : "text-[#0000F2] font-bold"
                }
              >
                //
              </span>
            ...
            >
              <span
                className={`uppercase ${isCobalt ? "text-white/60" : "text-[#525252]"}`}
              >
                KẾT NỐI //
              </span>
              <a
              ...
              {activeVisualTab === "3d" ? (
                ...
                <div>
                  ...
                  >
                      ...
                      <span
                        className={
                          isCobalt
                            ...
                            : "text-[#0000F2] font-bold"
                        }
                      >
                        export const
                      </span>{" "}
                      <span
                        className={isCobalt ? "text-white" : "text-current"}
                      >
                        engineerProfile
                      </span>{" "}
                      = {"{"}
                    ...
                    <p
                      className={`pl-4 ${isCobalt ? "text-white/80" : "text-[#8e8e8e]"}`}
                    >
                      candidate:{" "}
                      <span
                        className={
                          isCobalt ? "text-white font-semibold" : "text-current"
                        }
                      >
                    ...
                    >
                      ...
                      >
                        'Medical AI (Grad-CAM++) & Full-Stack'
                      </span>
                      ,
                    </p>
                    <p
                    ...
                    >
                      ...
                      >
                        'B.Eng. Computer Science (GPA: 3.14/4.0)'
                      </span>
                      ,
                    </p>
                    <p
                    ...
                    >
                      ...
                      >
                        <Code2
                          className={`w-3.5 h-3.5 ${isCobalt ? "text-white" : "text-[#0000F2]"}`}
                        />
                        <div>
                          <div
                            className={`text-[9px] uppercase ${isCobalt ? "text-white/70" : "text-[#8e8e8e]"}`}
                          >
                            MÔ HÌNH AI
                          </div>
                ...
                >
                  ...
                  <div
                    className={`absolute top-2 left-2 text-[10px] font-mono pointer-events-none ${isCobalt || isLight ? "text-[#0000F2]/50" : "text-[#0000F2]/60"}`}
                  >
                    +
                  </div>
                  <div
                    className={`absolute top-2 right-2 text-[10px] font-mono pointer-events-none ${isCobalt || isLight ? "text-[#0000F2]/50" : "text-[#0000F2]/60"}`}
                  >
                    +
                  </div>
                  <div
                    className={`absolute bottom-2 left-2 text-[10px] font-mono pointer-events-none ${isCobalt || isLight ? "text-[#0000F2]/50" : "text-[#0000F2]/60"}`}
                  >
                    +
                  </div>
                  <div
                    className={`absolute bottom-2 right-2 text-[10px] font-mono pointer-events-none ${isCobalt || isLight ? "text-[#0000F2]/50" : "text-[#0000F2]/60"}`}
                  >
                    +
                  </div>
                  ...
                  >
                    <span>BD: 20/05/2004 // ENG_CS</span>
                    <span className="font-bold text-[#0000F2]">
                      [ STATUS: VERIFIED ]
                    </span>
                  </div>
                </div>
