...
export const personalProfile: PersonalProfile = {
  ...
  contact: {
    ...
    phone: "0795957824",
    location: "Tân Long, Tân Bình, Cần Thơ (Sẵn sàng On-site)",
  ...
  cvFiles: [
    {
      ...
      description:
        "Hồ sơ chuyên sâu về Computer Vision, PyTorch, Swin Transformer & Medical AI",
      fileName: "cv.pdf",
    },
    {
      name: "Bản Kỹ thuật viên & Phần mềm Full-Stack",
      description:
        "Hồ sơ chuyên môn Full-Stack Web (React 19, Node.js), .NET & Quản trị CSDL",
      fileName: "cv.pdf",
    },
  ],
  stats: [
  ...
  philosophies: [
    {
      ...
      description:
        "Không dừng lại ở lý thuyết mô hình, luôn chủ động đóng gói code thành ứng dụng hoàn thiện, ổn định và sẵn sàng bàn giao cho người dùng.",
      icon: "Zap",
    },
    {
      title: "Kiến Trúc Bền Vững & Toàn Vẹn Dữ Liệu",
      description:
        "Tuân thủ chuẩn hóa CSDL (3NF), kiểm soát tranh chấp đồng thời chặt chẽ (ACID), viết code module hóa và dễ mở rộng.",
      icon: "Code2",
    },
    {
      title: "Ứng Dụng AI Thế Hệ Mới Vào Thực Tế",
      description:
        "Tận dụng sức mạnh của Deep Learning, Explainable AI (Grad-CAM++) và các công cụ AI (Claude Code, Antigravity) để bứt phá tốc độ phát triển.",
      icon: "HeartHandshake",
    },
  ],
};
...
export const skillGroups: SkillGroup[] = [
  {
    ...
    description:
      "Thị giác máy tính, phân loại ảnh y tế và trực quan hóa Explainable AI",
    icon: "Cpu",
    skills: [
      {
        name: "PyTorch",
        level: 50,
        proficiency: "Tự tin sử dụng",
        icon: "Cpu",
        experienceYears: "< 1 năm",
        isCore: true,
      },
      {
        name: "EfficientNet-V2 & Swin Transformer",
        level: 52,
        proficiency: "Tự tin sử dụng",
        icon: "Atom",
        experienceYears: "< 1 năm",
  ...
  },
  {
    ...
    description:
      "Xây dựng giao diện tương tác cao cấp, Three.js 3D WebGL & Micro-interactions",
    icon: "Layout",
    skills: [
      {
        name: "ReactJS (React 18 & 19)",
        level: 75,
        proficiency: "Khá",
        icon: "Atom",
        experienceYears: "< 1 năm",
      ...
      {
        name: "Recharts (Biểu đồ phân tích)",
        level: 60,
        proficiency: "Khá",
        icon: "Boxes",
        experienceYears: "< 1 năm",
  ...
  },
  {
    ...
    description:
      "Hệ thống RESTful API, ASP.NET Core, Node.js & Real-time WebSockets",
    icon: "Server",
    skills: [
      {
      ...
      {
        name: "C# & ASP.NET Core 8 / WinForms",
        level: 60,
        proficiency: "Khá",
        icon: "FileCode2",
        experienceYears: "< 1 năm",
      ...
      {
        name: "RESTful API & WebSocket Sync",
        level: 45,
        proficiency: "Tìm hiểu",
        icon: "Wifi",
        experienceYears: "< 1 năm",
      ...
      {
        name: "Firebase JWT Authentication",
        level: 50,
        proficiency: "Tự tin sử dụng",
        icon: "ShieldCheck",
        experienceYears: "< 1 năm",
  ...
  },
  {
    ...
    description:
      "Microsoft SQL Server ACID, MongoDB, Docker & AI Workflow hiện đại",
    icon: "Database",
    skills: [
      {
        name: "Microsoft SQL Server (3NF, SqlTransaction)",
        level: 60,
        proficiency: "Khá",
        icon: "Database",
        experienceYears: "< 1 năm",
      ...
      {
        name: "MongoDB & Mongoose Pipeline",
        level: 45,
        proficiency: "Tìm hiểu",
        icon: "FolderGit2",
        experienceYears: "< 1 năm",
      ...
      {
        name: "Cloudinary CDN Media Sync",
        level: 65,
        proficiency: "Khá",
        icon: "Cloud",
        experienceYears: "1 năm",
      ...
      {
        name: "AI Workflow (Claude Code, Codex, Antigravity)",
        level: 80,
...
export const projects: Project[] = [
  {
    ...
    category: "ai",
    description:
      "Nghiên cứu, huấn luyện và đóng gói trọn gói giải pháp AI hỗ trợ y bác sĩ chẩn đoán và phân loại 4 nhóm u não (Glioma, Meningioma, Pituitary, No Tumor) từ ảnh chụp cộng hưởng từ MRI với cơ chế giải thích quyết định lâm sàng.",
    longDescription:
  ...
  },
  {
    id: "soundwave-hub",
    title:
      "SoundWave Hub — Nền Tảng Nghe Nhạc Trực Tuyến & Real-Time Dashboard",
    category: "web",
    description:
      "Nền tảng web phát trực tuyến âm thanh trọn gói (Client & Admin) với giao diện người dùng hiện đại, quản lý hàng đợi nghe nhạc linh hoạt và bảng điều khiển phân tích số liệu tương tác theo thời gian thực.",
    longDescription:
  ...
  },
  {
    ...
    category: "desktop",
    description:
      "Phần mềm máy tính (Desktop App) phục vụ quản lý toàn diện quy trình mượn/trả sách, độc giả và tự động hóa tính phạt quá hạn cho thư viện trường học và doanh nghiệp.",
    longDescription:
      "Phát triển bằng C# WinForms (.NET Framework) kết nối Microsoft SQL Server qua ADO.NET. Khảo sát bài toán thực tế, thiết kế cơ sở dữ liệu đạt chuẩn chuẩn hóa 3NF, thiết lập Indexing và Stored Procedures tối ưu hóa tốc độ truy vấn. Ứng dụng kỹ thuật xử lý giao dịch SqlTransaction để kiểm soát tranh chấp đồng thời phức tạp, đảm bảo tính toàn vẹn dữ liệu (ACID) và triệt tiêu 100% lỗi lệch số lượng tồn kho khi nhiều thủ thư thao tác cùng lúc.",
    tags: [
      "C#",
      "WinForms (.NET)",
      "SQL Server",
...
export const experiences: ExperienceItem[] = [
  {
    ...
    achievements: [
      ...
      "Kỹ năng & Giấy phép: Chứng chỉ tiếng Anh B1 (CEFR), Chứng chỉ Kỹ năng mềm.",
    ],
    technologies: [
      "Khoa học Máy tính",
      "Deep Learning",
  ...
  {
    id: "exp-2",
    period: "03/2022 — 05/2026",
    role: "Thực tập sinh Phát triển & Quản trị Website",
    company: "Công Ty Cổ Phần MKS (MKSolar)",
    location: "Cần Thơ, Việt Nam",
    type: "Dự án / Học tập",
    achievements: [
      "Trực tiếp phát triển, tùy biến Theme & Plugin trên nền tảng WordPress & WooCommerce cho website doanh nghiệp chính thức: [mksolar.vn](https://mksolar.vn/).",
      "Tối ưu hóa hiệu năng website (PageSpeed, Cache, tối ưu hóa ảnh), thiết kế giao diện chuẩn Responsive tương thích đa thiết bị và triển khai cấu trúc SEO On-page giúp gia tăng lưu lượng truy cập tự nhiên.",
      "Quản trị cơ sở dữ liệu danh mục sản phẩm (thiết bị điện mặt trời, Inverter, pin lưu trữ BESS) và tích hợp các kênh tương tác khách hàng thời gian thực (Zalo API, Hotline).",
      "Quản trị hosting, hệ thống CSDL MySQL qua cPanel; giám sát an toàn thông tin và thực hiện quy trình sao lưu (backup) định kỳ, đảm bảo tính sẵn sàng cao của hệ thống.",
    ],
    technologies: [
      "WordPress",
      "WooCommerce",
